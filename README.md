...
- Modernise and uplift **legacy applications**
- Apply **SOLID principles and design patterns** where they add real value
- Automate deployments, migrations, and operational tasks
- Ship software that people actually rely on
...
- Entity Framework, RESTful APIs, integration services

**Frontend**
- React, TypeScript, JavaScript
- Razor (where appropriate)
...
- Systems that are easy to operate at 2am  

---

## 🔗 Elsewhere
- LinkedIn: https://www.linkedin.com/in/gregg-steffensen-8bb69214/

---

If you’re reviewing this for a role:  
look at **commit history, structure, and decisions** — not just the final result.
